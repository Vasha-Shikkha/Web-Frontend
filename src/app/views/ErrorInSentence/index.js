...
import ErrorInSentenceCard from "../../components/ExerciseCard/ErrorInSentenceCard";
	...
	return (
		<>
			...
			{loading ? (
				...
				<ExerciseLayout
					exerciseName="Error in Sentence"
					scrollable={true}
...
export default ErrorInSentence;
